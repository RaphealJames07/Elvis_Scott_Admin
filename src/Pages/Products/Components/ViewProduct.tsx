                        ...
                        <div className="w-full h-max flex flex-col gap-4">
                            ...
                            <div className="w-full h-max flex flex-col gap-2">
                                ...
                                <p className="text-xs">
                                    ...
                                    adipisicing elit. Rerum, sit. Dolores eius
                                    aliquid iure maiores enim esse ea blanditiis
                                    porro, soluta dolorum assumenda dicta
                                    accusantium aut natus inventore, sed
                                    obcaecati! Lorem ipsum dolor sit amet
                                    consectetur adipisicing elit. Consequuntur
                                    est quia sapiente in? Maxime tenetur cum
                                    officiis incidunt illo doloribus repellendus
                                    omnis mollitia rem quasi possimus dolorum
                                    repellat, nihil perspiciatis?
                                </p>
                            </div>
